...
VerticalTabs.prototype = {
	init: function() {
		...
		this.installStylesheet(self.data.url("skin/base.css"));
	...
	getThemeStylesheet: function(theme) {
		...
		switch (theme) {
			case "winnt":
				stylesheet = "skin/win7/win7.css";
				break;
			case "darwin":
				stylesheet = "skin/darwin/darwin.css";
				break;
			case "linux":
				stylesheet = "skin/linux/linux.css";
				break;
			case "light":
				stylesheet = "skin/light/light.css";
				break;
			case "dark":
			default:
				stylesheet = "skin/dark/dark.css";
				break;
		}
